...
//if(isset($_POST['submit'])){   //nqs klikon ne submit
    /*
     ...
     */
    $query_insert = "INSERT INTO `users`.`users`
                     set name    = '" . $name . "',
                     username    = '" . $surname . "',
...
//    $query_insert = "INSERT INTO `users`.`users` (`name`, `username`, `email`, `password`)
